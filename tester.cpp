...
int main(int argc, char *argv[]){
	...
	int num_outputPixels = 8 * 12 * 12;
//	int num_outputPixels = 1 * 14 * 14;
	...
	fs.open("C:/Users/user/Desktop/Embbed_Application/MNIST_Inference_Device/hlsTest_float_folder/pool1_output.txt");
